...
public class AndRenderer : MonoBehaviour
{
    ...
    {
        m_quad = GenerateQuad();
        m_sh_and = AssetDatabase.LoadAssetAtPath<Shader>("Assets/IstEffects/ScreenSpaceBoolean/Shaders/CompositeAnd.shader");
    }
#endif // UNITY_EDITOR
    ...
    void UpdateCommandBuffer()
    {
        if (m_commands == null)
        {
            ...
            m_mat_composite = new Material(m_sh_and);
        }
