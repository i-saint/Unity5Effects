...
namespace Ist
{
    ...
    public class AndRenderer : MonoBehaviour
    {
        ...
        void IssueDrawcalls(HashSet<IAndReceiver> receivers, HashSet<IAndOperator> operators)
        {
            ...
            foreach (var rcv in receivers)
            {
                if (rcv != null)
                {
                    rcv.IssueDrawCall_BackDepth(this, m_commands);
                }
            }
            ...
            foreach (var op in operators)
            {
                if (op != null)
                {
                    op.IssueDrawCall_BackDepth(this, m_commands);
                }
            }
            ...
            foreach (var rcv in receivers)
            {
                if (rcv != null)
                {
                    rcv.IssueDrawCall_FrontDepth(this, m_commands);
                }
            }
            ...
            foreach (var op in operators)
            {
                if (op != null)
                {
                    op.IssueDrawCall_FrontDepth(this, m_commands);
                }
            }
