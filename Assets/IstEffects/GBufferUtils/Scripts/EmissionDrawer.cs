...
namespace Ist
{
    ...
    [AddComponentMenu("IstEffects/GBufferUtils/EmissionDrawer")]
    ...
    public class EmissionDrawer : ICommandBufferExecuter<EmissionDrawer>
    {
        ...
        void Reset()
        {
            var mat = AssetDatabase.LoadAssetAtPath<Material>("Assets/IstEffects/GBufferUtils/Materials/Depth.mat");
