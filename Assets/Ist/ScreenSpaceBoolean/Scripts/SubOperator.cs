...
namespace Ist
{
    [AddComponentMenu("Ist/ScreenSpaceBoolean/SubOperator")]
    ...
    public class SubOperator : ISubOperator
    {
        ...
        void Reset()
        {
            ...
            var mat = AssetDatabase.LoadAssetAtPath<Material>("Assets/Ist/ScreenSpaceBoolean/Materials/Default_SubOperator.mat");
